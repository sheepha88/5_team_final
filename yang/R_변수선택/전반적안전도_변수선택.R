...
fit2<-lm(score_전반~crm_wthr_눈+crm_wthr_만월+crm_wthr_맑음+crm_wthr_바람
+crm_wthr_비+crm_wthr_안개+crm_wthr_암흑+crm_wthr_폭설+crm_wthr_폭풍우+crm_wthr_흐림
...
+vic_age_2_30대+vic_age_4_50대+vic_age_60세초과+crm_tm_새벽
+crm_tm_오전+crm_tm_오후+crm_tm_저녁+전반적_발생수+전반적_검거수+전반적_검거율
+화재건수+화재_사망+화재_부상
#+화재_인명피해_계
...
+자살_사망률_10만명당+자살_연령표준화사망률_10만명당+총_인구수+기초수급_19세이하
...
#nvmax, 변수개수 지정
result2<-regsubsets(score_전반~crm_wthr_눈+crm_wthr_만월+crm_wthr_맑음+crm_wthr_바람
                    +crm_wthr_비+crm_wthr_안개+crm_wthr_암흑+crm_wthr_폭설+crm_wthr_폭풍우+crm_wthr_흐림
                    +crm_clue_고발+crm_clue_고소+crm_clue_변사체+crm_clue_불심검문
                    +crm_clue_여죄+crm_clue_자수+crm_clue_진정+crm_clue_타인신고+crm_clue_탄원
                    +crm_clue_탐문정보+crm_clue_투서+crm_clue_피해자신고+crm_clue_피해품발견
...
fit5<- lm(score_전반~+crm_wthr_흐림+crm_clue_피해자신고+crm_clue_현행범+crm_tm_저녁
...
#leaps한 후 ols확인, 다중공산성 확인
fit6<- lm(score_전반~+crm_wthr_흐림+crm_clue_타인신고+crm_clue_피해자신고
          +crm_clue_현행범+crm_tm_저녁
          +화재_사망+배치인원_수+비상벨_개수+기초수급_19세이하+외국인수,data=dt)
summary(fit6)
